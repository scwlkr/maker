...
| `FIRST_MODEL_TOOL_CHOICE` | empty | Optional provider `tool_choice` override for only the first model request in a wake; supports the same values as `MODEL_TOOL_CHOICE` |
